...
def descriptive_name(param_col, is_cost=None):
    ...
    column_name_map = {
        ...
        # new param names for LLMs and other fixes
        "params_critique_agent_llm_name": "Critique Agent LLM",
        "params_critique_agent_llm_temperature": "Critique Agent LLM Temperature",
        "params_critique_agent_llm_top_p": "Critique Agent LLM Top-P",
        "params_critique_agent_llm_use_reasoning": "Critique Agent LLM Use Reasoning",
        "params_hyde_llm_temperature": "HyDE LLM Temperature",
        "params_hyde_llm_top_p": "HyDE LLM Top-P",
        "params_hyde_llm_use_reasoning": "HyDE LLM Use Reasoning",
        "params_lats_max_rollouts": "LATS Agent Maximum Number of Rollouts",
        "params_lats_num_expansions": "LATS Agent Maximum Number of Expansions",
        "params_rag_query_decomposition_llm_temperature": "RAG Query Decomposition LLM Temperature",
        "params_rag_query_decomposition_llm_top_p": "RAG Query Decomposition LLM Top-P",
        "params_rag_query_decomposition_llm_use_reasoning": "RAG Query Decomposition LLM Use Reasoning",
        "params_reflection_agent_llm_name": "Reflection Agent LLM",
        "params_reflection_agent_llm_temperature": "Reflection Agent LLM Temperature",
        "params_reflection_agent_llm_top_p": "Reflection Agent LLM Top-P",
        "params_reflection_agent_llm_use_reasoning": "Reflection Agent LLM Use Reasoning",
        "params_reranker_llm_temperature": "Reranker LLM Temperature",
        "params_reranker_llm_top_p": "Reranker LLM Top-P",
        "params_reranker_llm_use_reasoning": "Reranker LLM Use Reasoning",
        "params_response_synthesizer_llm_name": "Response Synthesizer LLM",
        "params_response_synthesizer_llm_temperature": "Response Synthesizer LLM Temperature",
        "params_response_synthesizer_llm_top_p": "Response Synthesizer LLM Top-P",
        "params_response_synthesizer_llm_use_reasoning": "Response Synthesizer LLM Use Reasoning",
        "params_subquestion_engine_llm_name": "Subquestion Engine LLM",
        "params_subquestion_engine_llm_temperature": "Subquestion Engine LLM Temperature",
        "params_subquestion_engine_llm_top_p": "Subquestion Engine LLM Top-P",
        "params_subquestion_engine_llm_use_reasoning": "Subquestion Engine LLM Use Reasoning",
        "params_subquestion_response_synthesizer_llm_name": "Subquestion Response Synthesizer LLM",
        "params_subquestion_response_synthesizer_llm_temperature": "Subquestion Response Synthesizer LLM Temperature",
        "params_subquestion_response_synthesizer_llm_top_p": "Subquestion Response Synthesizer LLM Top-P",
        "params_subquestion_response_synthesizer_llm_use_reasoning": "Subquestion Response Synthesizer LLM Use Reasoning",
    }
